...
@ComponentScan(basePackages  = { "com.thoughtmechanix.authentication","com.thoughtmechanix.common" },
        excludeFilters = { @ComponentScan.Filter(type = FilterType.REGEX, pattern = ".*ServiceSecurityConfiguration") })
