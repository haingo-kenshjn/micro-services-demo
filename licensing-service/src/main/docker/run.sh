...
java -Djava.security.egd=file:/dev/./urandom -Dserver.port=$SERVER_PORT   \
     ...
     -Dspring.profiles.active=$PROFILE -Xdebug -Xrunjdwp:server=y,transport=dt_socket,address=8000,suspend=n -jar /usr/local/licensingservice/@project.build.finalName@.jar
